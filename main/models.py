...
class Bb(models.Model):
    ...
    image = models.ImageField(upload_to=get_timestamp_path, blank=True, verbose_name='Изображения')
    author = models.ForeignKey(AdvUser, on_delete=models.CASCADE, verbose_name='Автор обьвления')
    is_active = models.BooleanField(default=True, db_index=True, verbose_name='Выводить всписке?')
